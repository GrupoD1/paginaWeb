...
function anadirNuevo(){
    ...
    allProducts.push({name: document.getElementById("titulo").value, description: document.getElementById("descrip").value, precio:document.getElementById("precio").value, cantidad:document.getElementById("cantidad").value,image:"IMG/"+document.getElementById("foto").value});
    localStorage.setItem("products",JSON.stringify(allProducts));
}
    /**
